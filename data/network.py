...
def centralityAnalysis(cursor,inputFile,matrixNum, numTimes, dir):
    ...
    multplier = len(inputFile)
    data = {'InputFile': inputFile*5,
    ...
    df = pd.DataFrame(data, columns=['Type','InputFile', 'Mean', 'Std'])
